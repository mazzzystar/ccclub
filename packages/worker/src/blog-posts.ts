...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: `
      ...
      <p>Since the initial release, ccclub has grown to support multiple coding agents. It now reads usage logs from Claude Code, Codex, OpenCode, Amp, Grok, Pi, and Cursor. If you use more than one, all of them show up in the same leaderboard.</p>
