...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  // Claude models — cacheCreation is 0 because Claude Code / Pro / Max
  // subscriptions do not charge for cache writes; only the API pay-as-you-go
  // tier does. Since ccclub targets subscription users, we match ccusage behavior.
  "claude-opus-4-7": { input: 5, output: 25, cacheCreation: 0, cacheRead: 0.5 },
  "claude-opus-4-6": { input: 5, output: 25, cacheCreation: 0, cacheRead: 0.5 },
  "claude-opus-4-5": { input: 5, output: 25, cacheCreation: 0, cacheRead: 0.5 },
  "claude-opus-4-5-20251101": { input: 5, output: 25, cacheCreation: 0, cacheRead: 0.5 },
  "claude-opus-4-1-20250805": { input: 15, output: 75, cacheCreation: 0, cacheRead: 1.5 },
  "claude-sonnet-4-6": { input: 3, output: 15, cacheCreation: 0, cacheRead: 0.3 },
  "claude-sonnet-4-5": { input: 3, output: 15, cacheCreation: 0, cacheRead: 0.3 },
  "claude-sonnet-4-5-20250929": { input: 3, output: 15, cacheCreation: 0, cacheRead: 0.3 },
  "claude-sonnet-4-20250514": { input: 3, output: 15, cacheCreation: 0, cacheRead: 0.3 },
  "claude-3-5-sonnet-20241022": { input: 3, output: 15, cacheCreation: 0, cacheRead: 0.3 },
  "claude-haiku-4-5-20251001": { input: 1, output: 5, cacheCreation: 0, cacheRead: 0.1 },
  "claude-3-5-haiku-20241022": { input: 0.8, output: 4, cacheCreation: 0, cacheRead: 0.08 },
