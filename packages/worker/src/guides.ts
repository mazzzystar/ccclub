  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. ccusage reports both locally, and ccclub shows both (plus OpenCode, Amp, and pi-agent) on one shared leaderboard, with each person's agent mix.",
      },
      {
  ...
  },
  {
    ...
    body: `
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Agent coverage</td><td>Very broad (15+ CLIs)</td><td>Claude Code, Codex, OpenCode, Amp, pi-agent</td></tr>
    ...
    faq: [
      ...
      },
      {
        ...
        a: "ccusage covers more CLIs overall. ccclub currently supports Claude Code, Codex, OpenCode, Amp, and pi-agent — the ones it can sync into a shared leaderboard.",
      },
      {
  ...
  },
  {
    ...
    body: `
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Agents beyond Claude Code</td><td>Some</td><td>Claude-focused</td><td>Claude-focused</td><td>Codex, OpenCode, Amp, pi-agent</td></tr>
    ...
    faq: [
      ...
      },
      {
        ...
        a: "ccclub tracks Claude Code, Codex, OpenCode, Amp, and pi-agent on one board and shows each member's agent mix. Most other leaderboards are Claude-focused.",
      },
      {
